<form class="w-25" action="index.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="release_date" class="form-control" id="exampleInputPassword1" placeholder="release_date"
      required>
  </div>
  ...
  <div class="form-group">
    ...
    <input name="image" type="file" accept="image/png, image/jpeg" class="form-control-file"
