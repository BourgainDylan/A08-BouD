...
<form class="w-25" action="index.php" method="POST" enctype="multipart/form-data">
    <div>
        <div class="form-group">
            ...
            <input type="text" <?php  echo' value="'.$editactorsform[0]['first_name'].' " '; ?> name="NewfirstnameActor"
                class="form-control" id="exampleInputPassword1" placeholder="Insérez nom" required>
        </div>

        <div class="form-group">
            <label for="exampleInputPassword1">Prénoms</label>
            <input type="text" <?php  echo' value="'.$editactorsform[0]['last_name'].' " '; ?> name="NewsurnameActor"
                class="form-control" id="exampleInputPassword1" placeholder="insérez prénom" required>
        </div>
